    ...
    <AdminLayout>
        <div class="form-page">
            ...
            <form @submit.prevent="submit" class="form">
                <label>
                    {{ t('admin.forms.name') }}
                    <input v-model="form.name" type="text" :placeholder="t('admin.forms.name')" required />
                </label>

                <label>
                    {{ t('admin.forms.location') }}
                    <input v-model="form.location" type="text" :placeholder="t('admin.forms.location')" />
                </label>

                <label>
                    {{ t('admin.forms.description') }}
                    <textarea v-model="form.description" :placeholder="t('admin.forms.description')"></textarea>
                </label>
